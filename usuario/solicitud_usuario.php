...
<div class="sidebar">
           ...
           <ul class="menu">
            <li><a href="../pantallas/usuarios.php"><i class="fas fa-home"></i><span> Inicio </span></a></li>
    ...
    <h4>Búsqueda de Solicitudes del Usuario</h4>
    <form method="POST" action="ver_solicitudes.php">
