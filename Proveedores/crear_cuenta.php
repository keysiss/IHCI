...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO tbl_cuenta_proveedor (NUMERO_CUENTA, BANCO, DESCRIPCION_CUENTA, SALDO, ID_PROVEEDOR) 
              VALUES (?, ?, ?, ?, ?)";
    
    $stmt = $conexion->prepare($query);
    $stmt->bind_param("ssssi", $numero_cuenta, $banco, $descripcion_cuenta, $saldo, $id_proveedor);
