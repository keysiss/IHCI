...
function obtenerDatostbl_solicitud_compra()
{
    $servidor = 'localhost';
    $bd = 'gestion_compras2';
    $usuario = 'root';
...
function generateTableHTML($data)
{
    ...
    $html .= '<tr>';
     ...
     $html .= '<th style="padding: 8px; border: 1px solid #ddd; font-weight: bold; text-align: left;">Número Solicitud</th>';
     $html .= '<th style="padding: 8px; border: 1px solid #ddd; font-weight: bold; text-align: left;">Fecha Solicitud</th>';
     $html .= '<th style="padding: 8px; border: 1px solid #ddd; font-weight: bold; text-align: left;">Monto Total</th>';
...
$datosTablaCompras = obtenerDatostbl_solicitud_compra();
...
$html .= generateTableHTML($datosTablaCompras);
...
$dompdf->stream('tabla_compras.pdf', ['Attachment' => false]);
